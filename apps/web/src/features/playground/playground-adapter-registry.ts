...
const commonParameterFields = {
  ...
  learningRate: {
    id: 'learningRate',
    kind: 'number',
    label: { en: 'Learning rate', vi: 'Learning rate' },
    min: 0.0001,
    max: 1,
    step: 0.001,
  },
  ...
  trainRatio: {
    id: 'trainRatio',
    kind: 'number',
    label: { en: 'Train split', vi: 'Train split' },
    min: 0.5,
    max: 0.9,
    step: 0.05,
  },
    ...
    parameterFields: [
      {
        id: 'alpha',
        kind: 'number',
        label: { en: 'Regularization alpha', vi: 'Regularization alpha' },
        min: 0.0001,
        max: 100,
        step: 0.1,
      },
    ...
    parameterFields: [
      {
        ...
        integer: true,
        kind: 'number',
        label: { en: 'Polynomial degree', vi: 'Polynomial degree' },
        min: 1,
        max: 5,
  ...
  },
  {
    ...
    parameterFields: [
      ...
      commonParameterFields.epochs(2000),
      {
        id: 'threshold',
        kind: 'number',
        label: { en: 'Threshold', vi: 'Threshold' },
        min: 0,
        max: 1,
        step: 0.05,
      },
    ...
    parameterFields: [
      {
        id: 'alpha',
        kind: 'number',
        label: { en: 'Smoothing alpha', vi: 'Smoothing alpha' },
        min: 0.0001,
        max: 100,
        step: 0.1,
      },
    ...
    parameterFields: [
      {
        ...
        integer: true,
        kind: 'number',
        label: { en: 'Nearest neighbors (k)', vi: 'Nearest neighbors (k)' },
        min: 1,
        max: 50,
  ...
  },
  {
    ...
    parameterFields: [
      ...
      },
      {
        ...
        integer: true,
        kind: 'number',
        label: { en: 'Max depth', vi: 'Max depth' },
        min: 1,
        max: 15,
  ...
  },
  {
    ...
    parameterFields: [
      ...
      },
      {
        ...
        integer: true,
        kind: 'number',
        label: { en: 'Min samples per leaf', vi: 'Min samples per leaf' },
        min: 1,
        max: 50,
        step: 1,
      },
    ...
    parameterFields: [
      {
        ...
        integer: true,
        kind: 'number',
        label: { en: 'Clusters (k)', vi: 'Clusters (k)' },
        min: 2,
        max: 10,
        maxByDeviceProfile: { mobile: 8 },
        step: 1,
      },
      {
        ...
        integer: true,
        kind: 'number',
        label: { en: 'Max iterations', vi: 'Max iterations' },
        min: 10,
        max: 300,
        step: 10,
      },
